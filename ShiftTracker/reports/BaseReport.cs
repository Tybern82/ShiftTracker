...
namespace com.tybern.ShiftTracker.reports {
    public abstract class BaseReport {
        ...
        public PdfDocument generate() {
            ...
            if ((isPasswordProtected) && (!string.IsNullOrWhiteSpace(TrackerSettings.Instance.PDFPassword))) {
        ...
        public Document createDocument() {
            ...
            if (h1 != null) {
                h1.Font.Name = "ZT Otez";
                h1.ParagraphFormat.SpaceAfter = Unit.FromPoint(24);
                h1.ParagraphFormat.Alignment = ParagraphAlignment.Center;
                h1.Font.Size = Unit.FromPoint(24);
            }

            var h2 = _result.Styles[StyleNames.Heading2];
            if (h2 != null) {
                h2.Font.Name = "ZT Otez";
                h2.ParagraphFormat.Alignment = ParagraphAlignment.Left;
                h2.ParagraphFormat.SpaceBefore = Unit.FromPoint(18);
